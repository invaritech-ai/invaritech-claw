...
- After a beta publish, run `ICLAW_NPM_TELEGRAM_PACKAGE_SPEC=openclaw@YYYY.M.D-beta.N ICLAW_NPM_TELEGRAM_CREDENTIAL_SOURCE=convex ICLAW_NPM_TELEGRAM_CREDENTIAL_ROLE=ci pnpm test:docker:npm-telegram-live`
  ...
  `ICLAW_QA_TELEGRAM_*` env credentials directly.
