...
- Spawned exec commands receive `ICLAW_SHELL=exec` for context-aware shell/profile rules.
...
- `ICLAW_BASH_PENDING_MAX_OUTPUT_CHARS`: pending stdout/stderr cap per stream (chars)
