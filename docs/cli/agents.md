...
openclaw agents add work --workspace ~/.iclaw/workspace-work
openclaw agents add ops --workspace ~/.iclaw/workspace-ops --bind telegram:ops --non-interactive
openclaw agents bindings
openclaw agents bind --agent work --bind telegram:ops
openclaw agents unbind --agent work --bind telegram:ops
openclaw agents set-identity --workspace ~/.iclaw/workspace --from-identity
...
`agents.defaults.skills` and `agents.list[].skills` in `iclaw.json`. See
...
- Example path: `~/.iclaw/workspace/IDENTITY.md`
