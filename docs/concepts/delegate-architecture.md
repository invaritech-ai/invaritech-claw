...
{
  id: "delegate",
  workspace: "~/.iclaw/workspace-delegate",
  tools: {
...
- Cron run history: `~/.iclaw/cron/runs/<jobId>.jsonl`
- Session transcripts: `~/.iclaw/agents/delegate/sessions`
...
- Workspace: `~/.iclaw/workspace-delegate`
- State: `~/.iclaw/agents/delegate/agent`
- Sessions: `~/.iclaw/agents/delegate/sessions`
...
```json5
{
  agents: {
    list: [
      { id: "main", workspace: "~/.iclaw/workspace" },
      {
        id: "delegate",
        workspace: "~/.iclaw/workspace-delegate",
        tools: {
...
~/.iclaw/agents/delegate/agent/auth-profiles.json
```
...
```json5
{
  agents: {
    list: [
      { id: "main", default: true, workspace: "~/.iclaw/workspace" },
      {
        id: "org-assistant",
        name: "[Organization] Assistant",
        workspace: "~/.iclaw/workspace-org",
        agentDir: "~/.iclaw/agents/org-assistant/agent",
