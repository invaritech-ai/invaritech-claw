...
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| **0** | **Inventory** — Map TUI→gateway wire-up, sub-agent entrypoints, cron + canvas mount paths, bundled extension list. **Task checklist:** [`2026-04-26-iclaw-phase-0-inventory-plan.md`](./2026-04-26-iclaw-phase-0-inventory-plan.md). | Filled inventory appendix from that plan (or sibling doc); no behavior change. |
