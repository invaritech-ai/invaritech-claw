...
- WSL2 runs the Gateway on `127.0.0.1:32768`
- Windows opens the Control UI in a normal browser at `http://127.0.0.1:32768/`
...
4. Control UI: are you opening `http://127.0.0.1:32768/` instead of a LAN IP?
