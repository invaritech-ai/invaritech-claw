...
`~/.iclaw/iclaw.json` under `plugins.entries.perplexity.config.webSearch.apiKey`.
...
`~/.iclaw/.env` (or your service environment). See [Env vars](/help/faq#env-vars-and-env-loading).
