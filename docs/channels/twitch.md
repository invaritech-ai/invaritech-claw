...
5. Configure the token:
   - Env: `ICLAW_TWITCH_ACCESS_TOKEN=...` (default account only)
...
```json5
{
  channels: {
    twitch: {
      ...
      accessToken: "oauth:abc123...", // OAuth Access Token (or use ICLAW_TWITCH_ACCESS_TOKEN env var)
...
```bash
ICLAW_TWITCH_ACCESS_TOKEN=oauth:abc123...
```
