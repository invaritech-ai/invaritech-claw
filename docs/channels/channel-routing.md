...
{
  agents: {
    list: [{ id: "support", name: "Support", workspace: "~/.iclaw/workspace-support" }],
  },
  bindings: [
...
Session stores live under the state directory (default `~/.iclaw`):

- `~/.iclaw/agents/<agentId>/sessions/sessions.json`
