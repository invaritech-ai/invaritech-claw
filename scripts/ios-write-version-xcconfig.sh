...
- ICLAW_IOS_VERSION = exact canonical iOS version
- ICLAW_MARKETING_VERSION = short iOS/App Store version
- ICLAW_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
ICLAW_IOS_VERSION = ${IOS_VERSION}
ICLAW_MARKETING_VERSION = ${MARKETING_VERSION}
ICLAW_BUILD_VERSION = ${BUILD_NUMBER}
EOF
