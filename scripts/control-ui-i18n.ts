...
const ENV_PROVIDER = "ICLAW_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "ICLAW_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "ICLAW_CONTROL_UI_I18N_THINKING";
const ENV_PI_EXECUTABLE = "ICLAW_CONTROL_UI_I18N_PI_EXECUTABLE";
const ENV_PI_ARGS = "ICLAW_CONTROL_UI_I18N_PI_ARGS";
const ENV_PI_PACKAGE_VERSION = "ICLAW_CONTROL_UI_I18N_PI_PACKAGE_VERSION";
const ENV_BATCH_CHAR_BUDGET = "ICLAW_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "ICLAW_CONTROL_UI_I18N_PROMPT_TIMEOUT";
