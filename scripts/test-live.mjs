...
const env = {
  ...process.env,
  ICLAW_LIVE_TEST: process.env.ICLAW_LIVE_TEST || "1",
  ICLAW_LIVE_TEST_QUIET: quietOverride ?? process.env.ICLAW_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.ICLAW_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
