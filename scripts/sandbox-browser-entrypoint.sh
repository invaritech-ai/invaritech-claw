...
CDP_PORT="${ICLAW_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${ICLAW_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${ICLAW_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${ICLAW_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${ICLAW_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${ICLAW_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${ICLAW_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${ICLAW_BROWSER_NOVNC_PASSWORD:-}"

DISABLE_GRAPHICS_FLAGS="${ICLAW_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${ICLAW_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${ICLAW_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
AUTO_START_TIMEOUT_MS="${ICLAW_BROWSER_AUTO_START_TIMEOUT_MS:-12000}"
...
if [[ -z "${CDP_SOURCE_RANGE}" ]]; then
  ...
  echo "[sandbox-browser] Set ICLAW_BROWSER_CDP_SOURCE_RANGE to an explicit CIDR to enable CDP access." >&2
else
