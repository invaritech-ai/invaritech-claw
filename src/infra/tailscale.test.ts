...
describe("tailscale helpers", () => {
  ...
  beforeEach(() => {
    envSnapshot = captureEnv(["ICLAW_TEST_TAILSCALE_BINARY", "NODE_ENV", "VITEST"]);
    process.env.ICLAW_TEST_TAILSCALE_BINARY = "tailscale";
  ...
  it("allows the test binary override in explicit test environments", () => {
    process.env.ICLAW_TEST_TAILSCALE_BINARY = "/tmp/test-tailscale";
  ...
  it("ignores the test binary override outside test environments", () => {
    process.env.ICLAW_TEST_TAILSCALE_BINARY = "/tmp/attacker-tailscale";
