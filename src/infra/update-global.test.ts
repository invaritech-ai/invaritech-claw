...
describe("update global helpers", () => {
  ...
  it("prefers explicit package spec overrides", () => {
    envSnapshot = captureEnv(["ICLAW_UPDATE_PACKAGE_SPEC"]);
    process.env.ICLAW_UPDATE_PACKAGE_SPEC = "file:/tmp/openclaw.tgz";
    ...
    expect(
      resolveGlobalInstallSpec({
        ...
        tag: "beta",
        env: { ICLAW_UPDATE_PACKAGE_SPEC: "openclaw@next" },
      }),
    ).toBe("openclaw@next");
  });
