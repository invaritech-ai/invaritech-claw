...
describe("ensureOpenClawCliOnPath", () => {
  ...
  function resetBootstrapEnv(pathValue = "/usr/bin") {
    ...
    delete process.env.ICLAW_PATH_BOOTSTRAPPED;
    delete process.env.ICLAW_ALLOW_PROJECT_LOCAL_BIN;
  ...
  it("is idempotent", () => {
    ...
    process.env.ICLAW_PATH_BOOTSTRAPPED = "1";
  ...
  it.each([
    ...
    ({ envValue, allowProjectLocalBin }) => {
      ...
      if (envValue === undefined) {
        ...
        process.env.ICLAW_ALLOW_PROJECT_LOCAL_BIN = envValue;
      }
