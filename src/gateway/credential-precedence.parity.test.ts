...
const gatewayEnv = {
  ICLAW_GATEWAY_TOKEN: "env-token", // pragma: allowlist secret
  ICLAW_GATEWAY_PASSWORD: "env-password", // pragma: allowlist secret
...
function withGatewayAuthEnv<T>(env: NodeJS.ProcessEnv, fn: () => T): T {
  const keys = ["ICLAW_GATEWAY_TOKEN", "ICLAW_GATEWAY_PASSWORD", "ICLAW_SERVICE_KIND"] as const;
