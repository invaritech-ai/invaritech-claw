...
const CODEX_HARNESS_LIVE = process.env.ICLAW_LIVE_CODEX_HARNESS === "1";
const CODEX_HARNESS_DEBUG = process.env.ICLAW_LIVE_CODEX_HARNESS_DEBUG === "1";
...
function snapshotEnv(): LiveEnvSnapshot {
  return snapshotLiveEnv(["ICLAW_TRAJECTORY", "ICLAW_TRAJECTORY_DIR"]);
}
...
describeLive("gateway live trajectory export", () => {
  ...
  it(
    ...
    async () => {
      ...
      process.env.ICLAW_TRAJECTORY = "1";
      process.env.ICLAW_TRAJECTORY_DIR = trajectoryDir;
