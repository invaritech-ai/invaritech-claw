...
beforeAll(async () => {
  envSnapshot = captureEnv(["ICLAW_GATEWAY_PORT", "ICLAW_GATEWAY_TOKEN"]);
  ...
  process.env.ICLAW_GATEWAY_PORT = String(gatewayPort);
  process.env.ICLAW_GATEWAY_TOKEN = gatewayToken;
