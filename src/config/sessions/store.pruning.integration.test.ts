...
describe("Integration: saveSessionStore with pruning", () => {
  ...
  beforeEach(async () => {
    ...
    savedCacheTtl = process.env.ICLAW_SESSION_CACHE_TTL_MS;
    process.env.ICLAW_SESSION_CACHE_TTL_MS = "0";
  ...
  afterEach(() => {
    ...
    if (savedCacheTtl === undefined) {
      delete process.env.ICLAW_SESSION_CACHE_TTL_MS;
    } else {
      process.env.ICLAW_SESSION_CACHE_TTL_MS = savedCacheTtl;
    }
  });
