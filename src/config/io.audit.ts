...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.ICLAW_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.ICLAW_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.ICLAW_WATCH_COMMAND),
