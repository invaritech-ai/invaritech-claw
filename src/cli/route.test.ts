...
describe("tryRouteCli", () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    originalDisableRouteFirst = process.env.ICLAW_DISABLE_ROUTE_FIRST;
    originalHideBanner = process.env.ICLAW_HIDE_BANNER;
    delete process.env.ICLAW_DISABLE_ROUTE_FIRST;
  ...
  afterEach(() => {
    ...
    if (originalDisableRouteFirst === undefined) {
      ...
      process.env.ICLAW_DISABLE_ROUTE_FIRST = originalDisableRouteFirst;
    }
  ...
  it("respects ICLAW_HIDE_BANNER for routed commands", async () => {
