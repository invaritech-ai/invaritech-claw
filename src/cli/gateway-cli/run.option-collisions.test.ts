...
describe("gateway run option collisions", () => {
  ...
  it.each([
    ...
    delete process.env.ICLAW_CLI_BACKEND_LOG_OUTPUT;
    ...
    expect(process.env.ICLAW_CLI_BACKEND_LOG_OUTPUT).toBe("1");
  });
