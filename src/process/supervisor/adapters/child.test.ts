...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.ICLAW_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.ICLAW_SERVICE_MARKER;
    vi.useRealTimers();
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.ICLAW_SERVICE_MARKER = originalServiceMarker;
    }
  });
