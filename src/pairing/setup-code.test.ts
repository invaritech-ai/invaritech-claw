...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("ICLAW_GATEWAY_TOKEN", "");
    vi.stubEnv("ICLAW_GATEWAY_PASSWORD", "");
    vi.stubEnv("ICLAW_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses ICLAW_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
