...
const originalUpdateInProgress = process.env.ICLAW_UPDATE_IN_PROGRESS;
...
async function runNonInteractiveRepair(params: {
  ...
  if (params.updateInProgress) {
    process.env.ICLAW_UPDATE_IN_PROGRESS = "1";
  } else {
    delete process.env.ICLAW_UPDATE_IN_PROGRESS;
  }
...
function setupGatewayTokenRepairScenario() {
  mocks.readCommand.mockResolvedValue({
    ...
    environment: {
      ICLAW_GATEWAY_TOKEN: "stale-token",
    },
  });
  mocks.auditGatewayServiceConfig.mockResolvedValue({
    ok: false,
    issues: [
      {
        ...
        message: "Gateway service ICLAW_GATEWAY_TOKEN does not match gateway.auth.token",
        level: "recommended",
      },
    ],
  });
...
describe("maybeRepairGatewayServiceConfig", () => {
  beforeEach(() => {
    ...
    mocks.resolveGatewayAuthTokenForService.mockImplementation(async (cfg: OpenClawConfig, env) => {
      ...
      const envToken = env.ICLAW_GATEWAY_TOKEN?.trim() || undefined;
  ...
  afterEach(() => {
    ...
    if (originalUpdateInProgress === undefined) {
      ...
      process.env.ICLAW_UPDATE_IN_PROGRESS = originalUpdateInProgress;
    }
  });
  ...
  it("uses ICLAW_GATEWAY_TOKEN when config token is missing", async () => {
    await withEnvAsync({ ICLAW_GATEWAY_TOKEN: "env-token" }, async () => {
      setupGatewayTokenRepairScenario();
  ...
  it("does not flag entrypoint mismatch when symlink and realpath match", async () => {
    setupGatewayEntrypointRepairScenario({
      currentEntrypoint: "/Users/test/Library/pnpm/global/5/node_modules/iclaw/dist/index.js",
      installEntrypoint:
        "/Users/test/Library/pnpm/global/5/node_modules/.pnpm/iclaw@2026.3.12/node_modules/iclaw/dist/index.js",
      realpath: async (value: string) => {
        if (value.includes("/global/5/node_modules/iclaw/")) {
          return value.replace(
            "/global/5/node_modules/iclaw/",
            "/global/5/node_modules/.pnpm/iclaw@2026.3.12/node_modules/iclaw/",
          );
        }
        return value;
      },
  ...
  it("still flags entrypoint mismatch when canonicalized paths differ", async () => {
    setupGatewayEntrypointRepairScenario({
      currentEntrypoint:
        "/Users/test/.nvm/versions/node/v22.0.0/lib/node_modules/iclaw/dist/index.js",
      installEntrypoint: "/Users/test/Library/pnpm/global/5/node_modules/iclaw/dist/index.js",
    });
  ...
  it("repairs entrypoint mismatch in non-interactive fix mode", async () => {
    setupGatewayEntrypointRepairScenario({
      currentEntrypoint: "/Users/test/Library/npm/node_modules/iclaw/dist/entry.js",
      installEntrypoint: "/Users/test/Library/npm/node_modules/iclaw/dist/index.js",
    ...
    await withEnvAsync(
      ...
      async () => {
        mocks.readCommand.mockResolvedValue({
          programArguments: gatewayProgramArguments,
          environment: {
            ICLAW_GATEWAY_TOKEN: "env-file-token",
          },
