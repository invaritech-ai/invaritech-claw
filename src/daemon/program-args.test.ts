...
describe("resolveGatewayProgramArguments", () => {
  ...
  it("uses realpath-resolved dist entry when running via npx shim", async () => {
    ...
    const entryPath = path.resolve("/tmp/.npm/_npx/63c3/node_modules/iclaw/dist/entry.js");
  ...
  it("prefers symlinked path over realpath for stable service config", async () => {
    // Simulates pnpm global install where node_modules/iclaw is a symlink
    // to .pnpm/iclaw@X.Y.Z/node_modules/iclaw
    const symlinkPath = path.resolve(
      "/Users/test/Library/pnpm/global/5/node_modules/iclaw/dist/entry.js",
    );
    const realpathResolved = path.resolve(
      "/Users/test/Library/pnpm/global/5/node_modules/.pnpm/iclaw@2026.1.21-2/node_modules/iclaw/dist/entry.js",
    );
    ...
    expect(result.programArguments[1]).toBe(
      path.resolve("/Users/test/Library/pnpm/global/5/node_modules/iclaw/dist/index.js"),
    );
  ...
  it("falls back to node_modules package dist when .bin path is not resolved", async () => {
    const argv1 = path.resolve("/tmp/.npm/_npx/63c3/node_modules/.bin/openclaw");
    const indexPath = path.resolve("/tmp/.npm/_npx/63c3/node_modules/iclaw/dist/index.js");
    process.argv = ["node", argv1];
