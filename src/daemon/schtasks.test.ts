...
describe("resolveTaskScriptPath", () => {
  it.each([
    {
      name: "uses default path when ICLAW_PROFILE is unset",
      env: { USERPROFILE: "C:\\Users\\test" },
      expected: path.join("C:\\Users\\test", ".openclaw", "gateway.cmd"),
    },
    {
      name: "uses profile-specific path when ICLAW_PROFILE is set to a custom value",
      env: { USERPROFILE: "C:\\Users\\test", ICLAW_PROFILE: "jbphoenix" },
      expected: path.join("C:\\Users\\test", ".openclaw-jbphoenix", "gateway.cmd"),
    },
    {
      name: "prefers ICLAW_STATE_DIR over profile-derived defaults",
      env: {
        USERPROFILE: "C:\\Users\\test",
        ICLAW_PROFILE: "rescue",
        ICLAW_STATE_DIR: "C:\\State\\openclaw",
      },
      expected: path.join("C:\\State\\openclaw", "gateway.cmd"),
    },
    {
      name: "falls back to HOME when USERPROFILE is not set",
      env: { HOME: "/home/test", ICLAW_PROFILE: "default" },
...
describe("readScheduledTaskCommand", () => {
  ...
  it("reads script from ICLAW_STATE_DIR override", async () => {
    await withScheduledTaskScript(
      {
        env: (tmpDir) => ({ ICLAW_STATE_DIR: path.join(tmpDir, "custom-state") }),
