...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    previousFastTestEnv = process.env.ICLAW_TEST_FAST;
  ...
  afterAll(() => {
    ...
    process.env.ICLAW_TEST_FAST = previousFastTestEnv;
  });

  beforeEach(() => {
    // ICLAW_TEST_FAST is set in beforeAll before module import
