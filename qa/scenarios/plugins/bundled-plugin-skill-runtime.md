...
successCriteria:
  - The runtime-packaged bundled plugin tree is used as ICLAW_BUNDLED_PLUGINS_DIR.
          ...
          expr: |-
            (async () => {
              ...
              const cliEnv = {
                ...
                ICLAW_OAUTH_DIR: path.join(stateDir, "credentials"),
                ICLAW_BUNDLED_PLUGINS_DIR: distRuntimeExtensions,
