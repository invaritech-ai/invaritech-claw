...
8. **NEVER start Codex inside your OpenClaw state directory** (`$ICLAW_STATE_DIR`, default `~/.openclaw`) - it'll read your soul docs and get weird ideas about the org chart!
