...
describe("browser control evaluate gating", () => {
  beforeEach(async () => {
    ...
    prevGatewayPort = process.env.ICLAW_GATEWAY_PORT;
    process.env.ICLAW_GATEWAY_PORT = String(testPort - 2);
    prevGatewayToken = process.env.ICLAW_GATEWAY_TOKEN;
    prevGatewayPassword = process.env.ICLAW_GATEWAY_PASSWORD;
