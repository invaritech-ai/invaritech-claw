...
const ENABLE_VYDRA_VIDEO_LIVE = process.env.ICLAW_LIVE_VYDRA_VIDEO === "1";
const LIVE_IMAGE_MODEL = process.env.ICLAW_LIVE_VYDRA_IMAGE_MODEL?.trim() || "grok-imagine";
const LIVE_VIDEO_MODEL = process.env.ICLAW_LIVE_VYDRA_VIDEO_MODEL?.trim() || "veo3";
...
const LIVE_KLING_IMAGE_URL =
  process.env.ICLAW_LIVE_VYDRA_KLING_IMAGE_URL?.trim() || DEFAULT_LIVE_KLING_IMAGE_URL;
