...
const providerFilter = parseCsvFilter(process.env.ICLAW_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.ICLAW_LIVE_MUSIC_GENERATION_MODELS);
