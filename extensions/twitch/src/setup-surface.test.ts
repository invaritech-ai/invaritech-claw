...
const originalEnvToken = process.env.ICLAW_TWITCH_ACCESS_TOKEN;
...
describe("setup surface helpers", () => {
  ...
  afterEach(() => {
    if (originalEnvToken === undefined) {
      delete process.env.ICLAW_TWITCH_ACCESS_TOKEN;
    } else {
      process.env.ICLAW_TWITCH_ACCESS_TOKEN = originalEnvToken;
    }
  ...
  describe("defaultAccount setup resolution", () => {
    ...
    it("reports env-token default account setup as configured", async () => {
      process.env.ICLAW_TWITCH_ACCESS_TOKEN = "oauth:fromenv";
