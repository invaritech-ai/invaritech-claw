...
declare global {
  ...
  var __ICLAW_TEST_REFRESH_OPENAI_CODEX_TOKEN__: ((...args: unknown[]) => unknown) | undefined;
}
...
vi.mock("@mariozechner/pi-ai/oauth", () => ({
  ...
  refreshOpenAICodexToken: vi.fn((...args: unknown[]) =>
    globalThis.__ICLAW_TEST_REFRESH_OPENAI_CODEX_TOKEN__?.(...args),
  ),
}));
...
process.env.ICLAW_PLUGIN_MANIFEST_CACHE_MS ??= "60000";
